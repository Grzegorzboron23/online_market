...
import com.solvd.enumeration.Position;
import com.solvd.exception.FileProcessingException;
import com.solvd.exception.InvalidAddressException;
import com.solvd.exception.InvalidSalaryException;
import com.solvd.info.*;
import com.solvd.product.Book;
import com.solvd.product.FoodProduct;
import com.solvd.product.Laptop;
import com.solvd.product.Product;
import com.solvd.productInterface.Spoiled;
import com.solvd.profitCalculator.ProductCalculator;
import com.solvd.service.EmployeeService;
import com.solvd.service.OnlineMarket;
import com.solvd.service.ProductService;
import com.solvd.utils.CustomLinkedList;
import com.solvd.utils.FileReadUtil;
import com.solvd.utils.FileReadWithResourcesUtil;
import com.solvd.warehouse.Warehouse;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        onlineMarket.setProducts(productList);  // Setter used as com.solvd.product list may be modified later
        onlineMarket.setEmployees(employeeList); // Setter used as com.solvd.employee list may be modified later
...
//        com.solvd.Main.demonstrateObjectMethodOverrides();
//        com.solvd.Main.demonstrateFinalStaticAndInterface();
...
//        com.solvd.Main.getFileInfo();
    ...
    public static List<Product> fillProductArray() {
        ...
        book.setProductDetails(productDetailsInfo); // Optional com.solvd.product details are set via setter
        ...
        laptop.setProductDetails(productDetailsInfo); // Optional com.solvd.product details set via setter
        ...
        foodProduct.setProductDetails(productDetailsInfo); // Optional com.solvd.product details set via setter
...
//        toString method
        ...
        System.out.println(employee); //toString result Person ... and default toString in employeeInfo like com.solvd.info.EmployeeInfo@...
...
//        equalsMethod
        ...
        System.out.println("com.solvd.employee.hashCode(): " + employee.hashCode());
        System.out.println("person.hashCode(): " + person.hashCode());
        //person and com.solvd.employee has the same hashcode because equals compares only they id's
...
//        abstract method getRoleDescription
        ...
        System.out.println(person.getRoleDescription()); //using getRoleDescription from com.solvd.employee because it's instantion of com.solvd.employee
        System.out.println(employee.getRoleDescription());
        System.out.println(cashier.getRoleDescription());  //using getRoleDescription from com.solvd.employee + adding more responsibilities
...
//       field of superclass
        ...
        System.out.println("Supervisor of manager (generalEmployee): " + cashier.getSupervisorDescription()); //get responsibilities from com.solvd.employee
...
//        Interfaces
    ...
    public static void demonstrateExceptions() {
        ...
        try {
            // Unchecked com.solvd.exception assuming we use calculator in our program to calculate salary
        ...
        try {
            //Unchecked  Assuming program calculates height of a com.solvd.product after some accident
            // don't need to be surrounded by try catch block
            size.setHeight(-10f);
        ...
        try {
            // Unchecked com.solvd.exception assuming the ID number is auto-created by a database
            // don't need to be surrounded by try catch block
    ...
    public static void demonstrateCollections() {
        ...
        System.out.println("Most paid com.solvd.employee " + EmployeeService.findMostPaidEmployee(Set.of(employee, employee2, cashier)));
    ...
    public static void demonstrateGenerics() {
        ...
        System.out.println("First com.solvd.employee " + customLinkedList.get(0));
...
//        Remove element
        ...
        System.out.println("First com.solvd.employee after remove " + customLinkedList.get(0));
        customLinkedList.add(0, cashier);
...
//        foreach loop
    ...
    private static void handleAddressSetting(AddressInfo addressInfo) {
        try {
            ...
            addressInfo.setCountry("P"); // This will throw an com.solvd.exception
            addressInfo.setCity("Wroclaw");
        } catch (InvalidAddressException e) {
    ...
    public static void checkSpoilage(Spoiled item) {
        if (item.isSpoiled()) {
            System.out.println("The com.solvd.product is spoiled.");
        } else {
            System.out.println("The com.solvd.product is still good.");
        }
    }

    public static void checkAllSpoiled(List<Spoiled> items) {
        for (Spoiled item : items) {
            System.out.println("Checking com.solvd.product...");
            if (item.isSpoiled()) {
                System.out.println("The com.solvd.product is spoiled.");
            } else {
                System.out.println("The com.solvd.product is in good condition.");
            }
        }
    }
